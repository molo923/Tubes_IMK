        ...
        <div class="row">
            ...
            <div class=" col-md-10" style="background-color: #D3D3D3;height: 70px; border: 1px grey solid;">
                ...
                <div class="row">
                    ...
                    <center>
                        <h5 style="padding-top: 10px;">Mulai Praktikum</h5>
                    </center>
                    <h6 style="padding-top: 10px; color: red">Jadwal sudah disesuaikan berdasarkan NIM</h6>
                    <form action="/action_page.php">
                      Praktikum:<br>   
                      <select name="praktikum">
                        <option value="jarkom">Jaringan Komputer</option>
                        <option value="pbd">Permodelan Basis Data</option>
                      </select>
                      <br><br>
                      Kelas:<br>    
                      <input type="text" name="kelas" value="IF-41-09">
                      <br><br>
                      Jadwal Praktikum:<br>   
                      <select name="jadwal">
                        <option value="1">Senin [12.30-15.30]</option>
                      </select>
                      <br><br>
                      Asprak: <br>  
                      <select name="asprak">
                        <option value="1">Adisca Naufal</option>
                        <option value="2">Bagas</option>
                      </select>
                      <br><br>
                      Authentifikasi:<br>   
                      ...
                      <input type="submit" value="Mulai Praktikum" name="submit" style="background: green; color: white; border-color: transparent;" onclick="window.location.href='index.php'">
                    </form>
                </div>
                </div>
